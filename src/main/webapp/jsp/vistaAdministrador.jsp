...
<%@page session="true" %>
<%@page import="mintic.edu.proyectoweb.modelo.Usuario" %>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <a class="navbar-brand" href="vistaAdministrador.jsp"><img src="../img/logo.png" width="50" height="50" alt="logo"/>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item">
                        <a style= "margin-left: 10px; border:none;"  class="btn btn-outline-light" href="cargarProductos.html" 
